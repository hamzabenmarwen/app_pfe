...
% CHAPITRE 2
% ============================================================
\chapter{Sprint 1 : Authentification et fondations}
...
\begin{itemize}
    ...
    \item \textbf{Vigiles} (middlewares) : intercep-tion du badge JWT avant toute opération sensible.
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{ui_login.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{ui_profile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{ui_admin_users.png}
